...
public class PackageInfoGenerator : IIncrementalGenerator
{
	...
	private static string GenerateSource(PackageInfo[] packages, string rootNamespace)
	{
		...
		sb.AppendLine();
		sb.AppendLine("/// <summary>");
		sb.AppendLine("/// Represents information about a third-party package dependency.");
		sb.AppendLine("/// </summary>");
		sb.AppendLine("/// <param name=\"Name\">The name of the package.</param>");
		sb.AppendLine("/// <param name=\"Version\">The version of the package.</param>");
		sb.AppendLine("/// <param name=\"Url\">The URL to the package on NuGet.org.</param>");
		sb.AppendLine("public record PackageInfo(string Name, string Version, string Url);");
